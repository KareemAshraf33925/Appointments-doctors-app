  ...
  <CommandList>
    ...
    <CommandGroup heading="Suggestions">
      ...
      <CommandItem>
         ...
         <img src={"/assets/images/categorys/doctor-performing-facial-injections.png"} 
      ...
      <CommandItem>
        <img src={"/assets/images/categorys/Hematology.png"} 
         className='cursor-pointer'
      ...
      <CommandItem>
        <img src={"/assets/images/categorys/istockphoto (2).png"} 
         className='cursor-pointer'
      ...
      <CommandItem>
        <img src={"/assets/images/categorys/istockphoto.png"} 
         className='cursor-pointer'
      ...
      <CommandItem>
          <img src={"/assets/images/categorys/lOshfbHtd5tvm7qi.png"} 
           className='cursor-pointer'
      ...
      <Link href={'/search/brain'}>
       <CommandItem>
         <img src={"/assets/images/categorys/neurosurgeon.png"}
              className='cursor-pointer'
